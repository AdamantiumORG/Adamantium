impl Encode for Op {
    fn encode<E: Encoder>(&self, encoder: &mut E) -> Result<E::Pos, E::Error> {
        match self {
            ...
            Self::CallIndirectTable0_R { table, func_type, params, index } => {
                (OpCode::CallIndirectTable0_R, table, func_type, params, index).encode(encoder)
            }
            Self::CallIndirect_R { table, func_type, params, index } => {
                (OpCode::CallIndirect_R, table, func_type, params, index).encode(encoder)
            }
            Self::CallIndirectTable0_S { table, func_type, params, index } => {
                (OpCode::CallIndirectTable0_S, table, func_type, params, index).encode(encoder)
            }
            Self::CallIndirect_S { table, func_type, params, index } => {
                (OpCode::CallIndirect_S, table, func_type, params, index).encode(encoder)
            }
            Self::ReturnCallIndirectTable0_R { table, func_type, params, index } => {
                (OpCode::ReturnCallIndirectTable0_R, table, func_type, params, index).encode(encoder)
            }
            ...
            Self::ReturnCallIndirectTable0_S { table, func_type, params, index } => {
                (OpCode::ReturnCallIndirectTable0_S, table, func_type, params, index).encode(encoder)
            }
